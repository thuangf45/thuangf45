...
I specialize in performance engineering for high-throughput .NET systems — finding bottlenecks and turning them into zero-allocation, high-concurrency code. My flagship work is **[LuciferCore](https://www.nuget.org/packages/LuciferCore)**, a high-performance .NET framework, and I write about the optimization process on **[Dev.to](https://dev.to/thuangf45)**.
